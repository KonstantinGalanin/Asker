...
def like_question(request):
    ...
    like, like_created = LikeQuestion.objects.get_or_create(question=question, user=profile)

    if not like_created:
        like.delete()
    
    body_response = {}
    body_response['likes_count'] = LikeQuestion.objects.filter(question=question).count()
